...
export const signupSchema = z.object({
  username: z.string('Username is required').trim().min(1, 'Username cannot be empty'),
  fullName: z.string('Full name is required').trim().min(1, 'Full name cannot be empty'),
